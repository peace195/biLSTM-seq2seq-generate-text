...
class Seq2SeqModel:
    ...
    def __init__(self, config, mode):
        ...
        if self.mode == 'predict':
            ...
            self.train_mode = config['train_mode'].value
            self.sampling_probability = config['sampling_probability'].value

        self.start_token = config['start_token'].value
        self.end_token = config['end_token'].value
